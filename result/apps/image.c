...
int main(int argc, char *argv[]) {
  ...
  button6 = gtk_button_new_with_label("unknown");
  button7 = gtk_button_new_with_label("unknown");
  ...
  gtk_table_attach_defaults(GTK_TABLE(table),button7,6,7,0,1);
  gtk_table_attach_defaults(GTK_TABLE(table),button8,6,7,1,2);
